    ...
    include-in-header: 
      - text: |
          ...
          \fancypagestyle{plain}{
            ...
            \fancyhead[RE, RO]{US Caribbean Yellowtail Snapper – Puerto Rico}
